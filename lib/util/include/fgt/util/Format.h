...
#ifndef fgt_FORMAT_DEBUG
#define fgt_FORMAT_DEBUG (0)
#endif
...
#if fgt_FORMAT_DEBUG == 1
        fgt_DEBUG6("formatResolvedFloat,", neg, m, exp, precision, pointOffset);
#endif
...
#if fgt_FORMAT_DEBUG == 1
        fgt_DEBUG4("formatAsFloat,", value, precision, pointOffset);
#endif
        bool neg;
        T m;
        int exp;
