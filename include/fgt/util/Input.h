...
public:
    ...
    virtual void update(InputContext *ic) override {
        fgt_LOG_DEBUG(ic->logger, ">>readValue.");
...
public:
    ...
    void update(InputContext *ic) override {
        ...
        fgt_LOG_DEBUG(ic->logger, String() << "<<readValue:" << this->value);
    }
